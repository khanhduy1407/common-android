...
import com.nkduy.lib.commons.dialogs.*
import com.nkduy.lib.commons.extensions.*
import com.nkduy.lib.commons.helpers.*
import com.nkduy.lib.commons.models.MyTheme
import com.nkduy.lib.commons.models.RadioItem
...
class CustomizationActivity : BaseSimpleActivity() {
        ...
        if (isThankYouInstalled()) {
            ...
            ensureBackgroundThread {
                try {
                    ...
                    toast(R.string.update_settings)
                    finish()
                }
            }
        } else {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.nkduy.cms.app.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
