...
import com.nkduy.lib.commons.extensions.removeUnderlines
import com.nkduy.lib.commons.extensions.setupDialogStuff
import kotlinx.android.synthetic.main.dialog_purchase_settings.view.*
...
class PurchaseSettingsDialog(val activity: Activity) {
    init {
        val view = activity.layoutInflater.inflate(R.layout.dialog_purchase_settings, null).apply {
            ...
            purchase_settings.text = Html.fromHtml(text)
            purchase_settings.movementMethod = LinkMovementMethod.getInstance()
            purchase_settings.removeUnderlines()
        }
