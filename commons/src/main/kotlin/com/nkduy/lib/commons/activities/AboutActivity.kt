...
import com.nkduy.lib.commons.dialogs.ConfirmationAdvancedDialog
import com.nkduy.lib.commons.dialogs.RateStarsDialog
...
class AboutActivity : BaseSimpleActivity() {
    ...
    private fun setupDonate() {
        if (resources.getBoolean(R.bool.show_donate_in_about)) {
            ...
            about_donate_holder.setOnClickListener {
                launchViewIntent("https://nkduy-common.web.app/donate")
            }
        } else {
    ...
    private fun setupWebsite() {
        if (resources.getBoolean(R.bool.show_donate_in_about)) {
            ...
            about_website_holder.setOnClickListener {
                launchViewIntent("https://nkduy-common.web.app/")
            }
        } else {
    ...
    private fun setupFacebook() {
        about_facebook_holder.setOnClickListener {
            var link = "https://www.facebook.com/khanhduy1407"
