...
import com.nkduy.lib.commons.models.*
import com.nkduy.lib.commons.views.MyTextView
...
fun Activity.launchPurchaseSettingsIntent() {
    try {
        launchViewIntent("market://details?id=com.nkduy.cms.app.settings")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.nkduy.cms.app.gallery.pro" || applicationId == "com.nkduy.cms.app.gallery.pro.debug") {
