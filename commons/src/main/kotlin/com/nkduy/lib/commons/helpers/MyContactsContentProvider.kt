package com.nkduy.lib.commons.helpers
...
import com.nkduy.lib.commons.extensions.getIntValue
import com.nkduy.lib.commons.extensions.getStringValue
import com.nkduy.lib.commons.models.PhoneNumber
import com.nkduy.lib.commons.models.SimpleContact

// used for sharing privately stored contacts in Contacts with Dialer, SMS Messenger and Calendar Pro
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.nkduy.lib.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.nkduy.cms.app.dialer" && packageName != "com.nkduy.cms.app.smsmessenger" && packageName != "com.nkduy.cms.app.calendar.pro") {
                return contacts
            }
