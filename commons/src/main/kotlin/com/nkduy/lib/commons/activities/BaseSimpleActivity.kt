package com.nkduy.lib.commons.activities
...
import com.nkduy.lib.commons.asynctasks.CopyMoveTask
import com.nkduy.lib.commons.dialogs.ConfirmationDialog
import com.nkduy.lib.commons.dialogs.ExportSettingsDialog
import com.nkduy.lib.commons.dialogs.FileConflictDialog
import com.nkduy.lib.commons.dialogs.WritePermissionDialog
import com.nkduy.lib.commons.extensions.*
import com.nkduy.lib.commons.helpers.*
import com.nkduy.lib.commons.interfaces.CopyMoveListener
import com.nkduy.lib.commons.models.FAQItem
import com.nkduy.lib.commons.models.FileDirItem
import java.io.File
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.nkduy.cms.app.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from nkduy-common.web.app. Thanks"
                ConfirmationDialog(this, label, positive = R.string.ok, negative = 0) {
                    launchViewIntent("https://play.google.com/store/apps/dev?id=5196625396723590310")
                }
            }
        }
    }
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        return if (!packageName.startsWith("com.nkduy.cms.app")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.nkduy.cms.app.")
