...
class MyContentProvider {
    companion object {
        private const val AUTHORITY = "com.nkduy.lib.commons.provider"
        const val SHARED_THEME_ACTIVATED = "com.nkduy.lib.commons.SHARED_THEME_ACTIVATED"
        const val SHARED_THEME_UPDATED = "com.nkduy.lib.commons.SHARED_THEME_UPDATED"
        val MY_CONTENT_URI = Uri.parse("content://$AUTHORITY/themes")

        const val COL_ID = "_id"    // used in Common Settings
