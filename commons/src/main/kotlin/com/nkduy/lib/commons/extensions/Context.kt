...
import com.nkduy.lib.commons.helpers.*
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_ACCENT_COLOR
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_APP_ICON_COLOR
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_BACKGROUND_COLOR
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_LAST_UPDATED_TS
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_NAVIGATION_BAR_COLOR
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_PRIMARY_COLOR
import com.nkduy.lib.commons.helpers.MyContentProvider.Companion.COL_TEXT_COLOR
import com.nkduy.lib.commons.models.AlarmSound
import com.nkduy.lib.commons.models.BlockedNumber
import com.nkduy.lib.commons.models.SharedTheme
import com.nkduy.lib.commons.views.*
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.nkduy.cms.app.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.nkduy.cms.app.settings")
...
fun Context.isAProApp() = packageName.startsWith("com.nkduy.cms.app.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.nkduy.cms.app."))
...
// we need the Default Dialer functionality only in Dialer and in Contacts for now
@TargetApi(Build.VERSION_CODES.M)
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.nkduy.cms.app.contacts") && !packageName.startsWith("com.nkduy.cms.app.dialer")) {
        true
    } else if ((packageName.startsWith("com.nkduy.cms.app.contacts") || packageName.startsWith("com.nkduy.cms.app.dialer")) && isQPlus()) {
